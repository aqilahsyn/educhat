...
<div class="flex gap-6 flex-1">
    ...
    {{-- ====== RIGHT: INFO PANEL (MATA KULIAH) ====== --}}
        ...
        {{-- konten dibuat scrollable biar kalau teks panjang tetap enak --}}
        <div class="flex-1 overflow-y-auto text-xs leading-relaxed text-slate-700 dark:text-slate-300 space-y-3">
            <p>
